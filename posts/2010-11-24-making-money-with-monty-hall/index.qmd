...
There's a fun and notorious probability problem known as the [Monty Hall problem](https://en.wikipedia.org/wiki/Monty_Hall_problem). It's famous for tripping up smart people. The setup is simple.
...
![The Monty Hall problem: you picked Door 1, the host reveals a goat behind Door 3. Do you switch to Door 2?](monty_open_door.svg){fig-alt="Three doors: Door 1 chosen by contestant, Door 3 opened showing a goat, Door 2 remaining closed." width=80% fig-align="center"}

<p class="figure-caption text-muted" style="text-align:center; font-size:0.8rem;">Illustration by <a href="https://commons.wikimedia.org/wiki/User:Cepheus~commonswiki">Cepheus</a>, via <a href="https://commons.wikimedia.org/wiki/File:Monty_open_door.svg">Wikimedia Commons</a>. Public domain.</p>
