...
There's a YouTube video that mentions the Monty Hall problem and the correct solution. A commenter insisted the real odds are 50-50 — and confronted with the possibility that [someone is wrong on the internet](http://xkcd.com/386/) — I engaged with YouTube user adolthitler.

After a lot of back and forth, the last volley was:

:::{.callout-note title="jbwhitmore (me)"}
...
:::{.callout-warning title="adolthitler"}
...
3. I am forced to **switch** to the remaining closed door. adolthitler is forced to **stay** with Door 1.
...
How many rounds would you like to play? A thousand? A million? Ten million? I'll play until someone goes bankrupt. Or [let the computer play a million rounds for you](../2010-11-25-monty-hall-monte-carlo-python/).
