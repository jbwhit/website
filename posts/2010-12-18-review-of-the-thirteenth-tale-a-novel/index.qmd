...
draft: true
description: "A mixed review of Diane Setterfield's gothic mystery novel The Thirteenth Tale, praising its atmosphere while critiquing its overly tidy plot resolutions."
categories: [books, personal]
status: needs-major-surgery
---

:::{.callout-important title="Needs major surgery before publishing"}
Dead image: the Amazon affiliate book cover image is broken. Replace with a cover from Open Library (openlibrary.org) or remove.
:::
