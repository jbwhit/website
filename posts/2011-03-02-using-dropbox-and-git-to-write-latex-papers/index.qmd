...
date: 2011-03-02
description: "A workflow for collaborating on LaTeX papers using Dropbox as a shared git remote, with tips on ignoring LaTeX build artifacts and writing one sentence per line for cleaner diffs."
author: Jonathan Whitmore
draft: true
categories: [latex, git, tools, productivity]
---
